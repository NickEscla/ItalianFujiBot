    ...
    def __init__(self, username, permitted_users, moderators, whisperMode, game, bot_type):
        ...
        if self.config:
            ...
            if self.config.get('daily_type'):
                ...
                self.daily_type = "hours"
            # ADDED daily hours TO CONFIG BY ITALIANSPY
            if self.config.get('daily_hours'):
                self.daily_hours = self.config.get('daily_hours')
            else:
                self.daily_hours = 24
            # ADDED daily time TO CONFIG BY ITALIANSPY
        ...
        # !does <pokemon> learn <move>
            ...
            while not success:
                try:
                    ...
                    pass
        # COMMAND FOR DIFFERENT DAILY TYPES BY ITALIANSPY
